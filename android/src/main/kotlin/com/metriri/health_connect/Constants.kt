...
class Constants {
    ...
    enum class RecordClass(val kC: KClass<out Record>, val permission: String) {
        ...
        BodyWaterMassRead(BodyWaterMassRecord::class, "READ_BODY_WATER_MASS"),
        ...
        HeartRateVariabilityRmssdRead(HeartRateRecord::class, "READ_HEART_RATE_VARIABILITY"),
        ...
        BodyWaterMassWrite(BodyWaterMassRecord::class, "WRITE_BODY_WATER_MASS"),
        ...
        HeartRateVariabilityRmssdWrite(HeartRateRecord::class, "WRITE_HEART_RATE_VARIABILITY"),
